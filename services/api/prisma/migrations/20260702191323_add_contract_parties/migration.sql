...
CREATE TABLE "contract_send_logs" (
    ...
    CONSTRAINT "contract_send_logs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "contract_send_logs_contract_id_idx" ON "contract_send_logs"("contract_id");
...
-- AddForeignKey
ALTER TABLE "contract_send_logs" ADD CONSTRAINT "contract_send_logs_contract_id_fkey" FOREIGN KEY ("contract_id") REFERENCES "contracts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
