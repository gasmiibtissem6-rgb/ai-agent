...
export class KycService {
  ...
  async handleWebhookStatusUpdate(
   ...
   // ---------------------------------------------------------------------------
  // Admin review queue (Next.js dashboard) — reintroduced from dev
  // ---------------------------------------------------------------------------

  /** Fetches the queue data tailored for the Next.js admin Table view. */
  async getPendingSubmissions() {
    ...
    return submissions.map((sub) => {
      ...
      return {
        ...
        docType: primaryFile?.originalFileName || 'Identity Document',
  ...
  /** Commits an admin review decision (approve/reject). */
  async processReview(
    submissionId: string,
