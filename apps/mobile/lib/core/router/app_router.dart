...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (status == AuthStatus.authenticated && isAuthRoute) return AppRoutes.home;
      if (status == AuthStatus.authenticated && state.matchedLocation == AppRoutes.splash) return AppRoutes.home;
      if (status != AuthStatus.authenticated && !isAuthRoute) return AppRoutes.login;
      return null;
    },
    routes: [
      GoRoute(
